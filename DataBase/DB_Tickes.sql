...
AS
BEGIN
    INSERT INTO Acce.tbUsuarios (Usro_Rol, Prsn_Id, Usro_Creacion, Usro_FechaCreacion, Usro_Modifica, Usro_FechaModificacion, Usro_Estado)
    VALUES (@Usro_Rol, @Prsn_Id, @Usro_Creacion, @Usro_FechaCreacion, @Usro_Modifica, @Usro_FechaModificacion, @Usro_Estado);
END;
GO -- UPDATE
